...
// const win = array.find(element => element === 'W')

// function superbowlWin(array) {
//     console.log(win ? array.year : undefined);
//     return win ? array.year : undefined;
// }
// superbowlWin(record);

//---------------------------------------------------------
//Third Try *Went back and updated* Passes both TESTS! 
...
//--------------------------------------------------------
//Second Try - passes second test

// function superbowlWin(array) {
//     console.log(array ? array.year : 'undefined');
...
//--------------------------------------------------------
// This works in the Console, but not the tests
...
//--------------------------------------------------------
//First Try (with returning inside of the function)

// function superbowlWin(array) {
//   if (array.result === "W") {
//       console.log(array.find(superbowlWin));
//       return array.find(superbowlWin), array.year;
//   }
// }
// superbowlWin(record)
